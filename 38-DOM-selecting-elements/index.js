...
const logAllParagraphs = () => {
    const convertParagraphs = Array.from(document.getElementsByTagName("P"));
    convertParagraphs.forEach(paragraph => {
 ...
 */
// https://hyperts.net/javascript-data-select/
...
const nextElements = document.querySelectorAll(".links ~ li");
